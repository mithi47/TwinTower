...
static float x = 0.5f, y = 1.85f, z = 5.0f;
...
{		
	...
	glLoadName(TEXTID); 
	DrawTextXY(-1, 3.2, 0.0, 0.002,  "  3D TWIN TOWER");

	glColor3f(0.0, 01.0, 1.0);
	glLoadName(TEXTID);
	DrawTextXY(-1, 3.5, 0.2, 0.002, "  MINI PROJECT ON");

	glColor3f(1.0, 0.8, 0.0);
	glLoadName(TEXTID);
	DrawTextXY(-1.85, 2, 1.0, 0.001,   "  SUBMITTED BY:  Mithilesh A (4AD19CS041)");

	glColor3f(1.0, 0.8, 0.0);
	glLoadName(TEXTID);
	DrawTextXY(-2, 1.8, 1.0, 0.001,   "                  Nagendra B  (4AD19CS048)");

	glColor3f(1.0, 0.8, 0.0);
	glLoadName(TEXTID);
	DrawTextXY(-1.9, 1.5, 1.0, 0.001, "   GUIDE       : Poornashree Narayani S Kulkarni");
	DrawTextXY(-1.9, 1.3, 1.0, 0.001, "                 Assistant Professor  ");
	DrawTextXY(-1.9, 1.1, 1.0, 0.001, "                 Computer Science Dept ATME CE");
...
void display()
{
	...
	{
		/****************Background color**************/
		if(time==0)glClearColor(0.56, 0.40, 0.9, 0.0);
		if(time==1)glClearColor(0.0, 1.0, 1.0, 0.0);
		if(time==2)glClearColor(1.0, 1.0, 1.0, 0.0);
		if(time==3)glClearColor(0.0, 0.0, 0.0, 0.0);
...
glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 79.0f, -19.0f);
		glVertex3f(20.1f, 75.0f, -19.0f);
		glVertex3f(20.1f, 75.0f, -15.25f);
		glVertex3f(20.1f, 79.0f, -15.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 79.0f, -14.25f);
		glVertex3f(20.1f, 75.0f, -14.25f);
		glVertex3f(20.1f, 75.0f, -10.5f);
		glVertex3f(20.1f, 79.0f, -10.5f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 79.0f, 15.250f);
		glVertex3f(20.1f, 75.0f, 15.25f);
		glVertex3f(20.1f, 75.0f, 19.0f);
		glVertex3f(20.1f, 79.0f, 19.0f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 74.0f, -19.0f);
		glVertex3f(20.1f, 70.0f, -19.0f);
		glVertex3f(20.1f, 70.0f, -15.25f);
		glVertex3f(20.1f, 74.0f, -15.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 74.0f, -14.25f);
		glVertex3f(20.1f, 70.0f, -14.25f);
		glVertex3f(20.1f, 70.0f, -10.5f);
		glVertex3f(20.1f, 74.0f, -10.5f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 74.0f, 15.250f);
		glVertex3f(20.1f, 70.0f, 15.25f);
		glVertex3f(20.1f, 70.0f, 19.0f);
		glVertex3f(20.1f, 74.0f, 19.0f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 69.0f, -19.0f);
		glVertex3f(20.1f, 65.0f, -19.0f);
		glVertex3f(20.1f, 65.0f, -15.25f);
		glVertex3f(20.1f, 69.0f, -15.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 69.0f, -14.25f);
		glVertex3f(20.1f, 65.0f, -14.25f);
		glVertex3f(20.1f, 65.0f, -10.5f);
		glVertex3f(20.1f, 69.0f, -10.5f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 69.0f, 15.250f);
		glVertex3f(20.1f, 65.0f, 15.25f);
		glVertex3f(20.1f, 65.0f, 19.0f);
		glVertex3f(20.1f, 69.0f, 19.0f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f,0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 64.0f, -19.0f);
		glVertex3f(20.1f, 60.0f, -19.0f);
		glVertex3f(20.1f, 60.0f, -15.25f);
		glVertex3f(20.1f, 64.0f, -15.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 64.0f, -14.25f);
		glVertex3f(20.1f, 60.0f, -14.25f);
		glVertex3f(20.1f, 60.0f, -10.5f);
		glVertex3f(20.1f, 64.0f, -10.5f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(20.1f, 64.0f, 15.250f);
		glVertex3f(20.1f, 60.0f, 15.25f);
		glVertex3f(20.1f, 60.0f, 19.0f);
		glVertex3f(20.1f, 64.0f, 19.0f);
		glEnd();
		...
		glEnd();
			...
			glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 79.0f, 11.0f);
		glVertex3f(9.9f, 75.0f, 11.0f);
		glVertex3f(9.9f, 75.0f, 14.25f);
		glVertex3f(9.9f, 79.0f, 14.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 79.0f, 15.25f);
		glVertex3f(9.9f, 75.0f, 15.25f);
		glVertex3f(9.9f, 75.0f, 19.5f);
		glVertex3f(9.9f, 79.0f, 19.5f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 79.0f, 40.5f);
		glVertex3f(9.9f, 75.0f, 40.5f);
		glVertex3f(9.9f, 75.0f, 44.25f);
		glVertex3f(9.9f, 79.0f, 44.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 79.0f, 45.25f);
		glVertex3f(9.9f, 75.0f, 45.25f);
		glVertex3f(9.9f, 75.0f, 49.0f);
		glVertex3f(9.9f, 79.0f, 49.0f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 74.0f, 11.0f);
		glVertex3f(9.9f, 70.0f, 11.0f);
		glVertex3f(9.9f, 70.0f, 14.25f);
		glVertex3f(9.9f, 74.0f, 14.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 74.0f, 15.25f);
		glVertex3f(9.9f, 70.0f, 15.25f);
		glVertex3f(9.9f, 70.0f, 19.5f);
		glVertex3f(9.9f, 74.0f, 19.5f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 74.0f, 40.5f);
		glVertex3f(9.9f, 70.0f, 40.5f);
		glVertex3f(9.9f, 70.0f, 44.25f);
		glVertex3f(9.9f, 74.0f, 44.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 74.0f, 45.25f);
		glVertex3f(9.9f, 70.0f, 45.25f);
		glVertex3f(9.9f, 70.0f, 49.0f);
		glVertex3f(9.9f, 74.0f, 49.0f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 69.0f, 11.0f);
		glVertex3f(9.9f, 65.0f, 11.0f);
		glVertex3f(9.9f, 65.0f, 14.25f);
		glVertex3f(9.9f, 69.0f, 14.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 69.0f, 15.25f);
		glVertex3f(9.9f, 65.0f, 15.25f);
		glVertex3f(9.9f, 65.0f, 19.5f);
		glVertex3f(9.9f, 69.0f, 19.5f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 69.0f, 40.5f);
		glVertex3f(9.9f, 65.0f, 40.5f);
		glVertex3f(9.9f, 65.0f, 44.25f);
		glVertex3f(9.9f, 69.0f, 44.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 69.0f, 45.25f);
		glVertex3f(9.9f, 65.0f, 45.25f);
		glVertex3f(9.9f, 65.0f, 49.0f);
		glVertex3f(9.9f, 69.0f, 49.0f);
		glEnd();
		...
		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 64.0f, 11.0f);
		glVertex3f(9.9f, 60.0f, 11.0f);
		glVertex3f(9.9f, 60.0f, 14.25f);
		glVertex3f(9.9f, 64.0f, 14.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 64.0f, 15.25f);
		glVertex3f(9.9f, 60.0f, 15.25f);
		glVertex3f(9.9f, 60.0f, 19.5f);
		glVertex3f(9.9f, 64.0f, 19.5f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 64.0f, 40.5f);
		glVertex3f(9.9f, 60.0f, 40.5f);
		glVertex3f(9.9f, 60.0f, 44.25f);
		glVertex3f(9.9f, 64.0f, 44.25f);
		glEnd();

		glColor3f(1.0f, 0.8f, 0.6f);
		glBegin(GL_QUADS);
		glVertex3f(9.9f, 64.0f, 45.25f);
		glVertex3f(9.9f, 60.0f, 45.25f);
		glVertex3f(9.9f, 60.0f, 49.0f);
		glVertex3f(9.9f, 64.0f, 49.0f);
		glEnd();
...
void menu()
{
	...
	glutAddMenuEntry("10) w:White Background", 1);
	glutAddMenuEntry("11) b:Night Light", 1);
	glutAddMenuEntry("12) d:Day Light", 1);
...
int main(int argc, char **argv)
{
	...
	glutCreateWindow("3D Twin Tower");
